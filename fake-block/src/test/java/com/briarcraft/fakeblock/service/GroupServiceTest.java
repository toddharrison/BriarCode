...
//    private @Mock FakeBlock fakeBlock;
//    private @Mock BlockPosition blockPosition;
//    private @Mock Location location;
//    private @Mock Block block;
//
...
//
//            // Act
//            service.create(groupName, world, fakeBlocks, false);
...
//
//            // Act
//            val response = service.create(groupName, world, fakeBlocks, false);
//
//            // Assert
//            assertTrue(response);
//
...
//            when(playerGroupService.getPlayersConfiguredIn(groupName)).thenReturn(Set.of(playerId));
...
//
//            verify(pluginManager).callEvent(any());
//            verify(playerGroupService).clearGroup(groupName, playerId);
//        }
//
//        @Test
//        public void callCancelled() {
...
//            val groupName = "1";
//            val chunkPosition = new ChunkPosition(0, 0);
//            val fakeBlocks = Set.of(fakeBlock);
//            val playerId = UUID.randomUUID();
//
//            when(servicesManager.getRegistration(PlayerGroupService.class)).thenReturn(playerGroupServiceProvider);
//            when(chunkService.toChunklets(any())).thenReturn(Set.of(chunklet));
//            when(chunkService.toChunk(any())).thenReturn(chunkPosition);
//            when(fakeBlock.getPosition()).thenReturn(blockPosition);
//            when(blockPosition.toLocation(world)).thenReturn(location);
...
//            verify(block, never()).setType(any(), anyBoolean());
//        }
//
//        @Test
...
//            when(chunklet.getPosition()).thenReturn(chunkletPosition);
//            when(fakeBlock.getPosition()).thenReturn(blockPosition);
//            when(fakeBlock.getBlockData()).thenReturn(blockData);
//            when(blockPosition.toLocation(world)).thenReturn(location);
//            when(location.getBlock()).thenReturn(block);
//
//            // Act
